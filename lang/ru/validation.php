...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'email_password' =>'Адрес электронной почты',
        'newpassword' =>'Введите пароль',
        'newpassword_repeat' =>'Повторите пароль',

        'nameFeedback' => 'Ваше имя',
        'emailFeedback' => 'Ваш адрес электронной почты',
        'message' => 'Описание проблемы',

        'name' => 'Заголовок новости',
        'short_descr' => 'Краткое описание новости',
        'descr' => 'Заголовок новости',

        'nameUpdate' => 'Заголовок новости',
        'short_descrUpdate' => 'Краткое описание новости',
        'descrUpdate' => 'Заголовок новости',
